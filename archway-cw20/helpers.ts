 ...
 *
 * Usage: npx @cosmjs/cli@^0.26 --init https://raw.githubusercontent.com/CosmWasm/cw-plus/v0.9.1/contracts/cw20-base/helpers.ts
 *
 * Create a client:
...
export const CW20 = (client: SigningCosmWasmClient, fees: Options["fees"]): CW20Contract => {
  ...
  const upload = async (senderAddress: string): Promise<number> => {
    const sourceUrl = "https://github.com/CosmWasm/cw-plus/releases/download/v0.9.1/cw20_base.wasm";
